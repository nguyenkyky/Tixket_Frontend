...
function Footer(props) {
  ...
  return (
    <div>
      <footer
        className="py-20 dark:bg-gray-100 dark:text-gray-900 text-black"
        style={{ backgroundColor: "#FDFCF0" }}
      >
        <hr style={{ borderTop: "1px solid red", marginTop: "2px" }} />
        ...
        <div className="mt-8 container px-6 mx-auto space-y-6 divide-y dark:divide-gray-600 md:space-y-12 divide-opacity-50">
          ...
          <div className="grid justify-center pt-6 lg:justify-between">
            ...
            <div className="flex justify-center pt-4 text-sm space-x-4 lg:pt-0 lg:col-end-13">
              Tixket © Created by Cao Ky Nguyen
            </div>
          </div>
        </div>
      </footer>
